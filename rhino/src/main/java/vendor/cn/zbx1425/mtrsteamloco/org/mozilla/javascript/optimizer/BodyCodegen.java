...
class BodyCodegen {
    ...
    private void generateGenerator() {
        ...
        if (fnCurrent != null) {
            ...
            cfw.addInvoke(
                    ...
                    "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable",
                    "getParentScope",
                    "()Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;");
        ...
        addScriptRuntimeInvoke(
                ...
                "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/NativeFunction;"
                        + "Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;"
                        + "[Ljava/lang/Object;"
                        + "Z"
                        + ")Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;");
        ...
        addOptRuntimeInvoke(
                ...
                "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/NativeFunction;"
                        + "Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;"
                        + "Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;II"
                        + ")Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;");
    ...
    private void generateActivationExit() {
        ...
        cfw.addALoad(contextLocal);
        addScriptRuntimeInvoke("exitActivationFunction", "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;)V");
    }
    ...
    private void generateThrowJavaScriptException() {
        cfw.add(ByteCode.NEW, "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/JavaScriptException");
        ...
        cfw.addInvoke(
                ByteCode.INVOKESPECIAL,
                "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/JavaScriptException",
                "<init>",
            ...
            case Token.REF_CALL:
                ...
                addScriptRuntimeInvoke(
                        ...
                        "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Callable;"
                                ...
                                + "[Ljava/lang/Object;"
                                + "Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;"
                                + ")Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Ref;");
                break;
            ...
            case Token.ADD:
                {
                    ...
                    switch (node.getIntProp(Node.ISNUMBER_PROP, -1)) {
                        ...
                        case Node.LEFT:
                            ...
                            addOptRuntimeInvoke(
                                    "add",
                                    "(DLjava/lang/Object;Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;)Ljava/lang/Object;");
                            break;
                        case Node.RIGHT:
                            cfw.addALoad(contextLocal);
                            addOptRuntimeInvoke(
                                    "add",
                                    "(Ljava/lang/Object;DLvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;)Ljava/lang/Object;");
                            break;
                        default:
                            cfw.addALoad(contextLocal);
                            addScriptRuntimeInvoke(
    ...
    private void generateYieldPoint(Node node, boolean exprContext) {
        if (unnestedYields.containsKey(node)) {
            ...
            if (exprContext) {
                ...
                addScriptRuntimeInvoke(
                        "getObjectPropNoWarn",
                        "(Ljava/lang/Object;Ljava/lang/String;Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;"
                                + "Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;)Ljava/lang/Object;");
            }
            return;
        }
        ...
        if (nestedYield != null) {
            ...
            addScriptRuntimeInvoke(
                    "setObjectProp",
                    "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;Ljava/lang/String;Ljava/lang/Object;"
                            + "Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;)Ljava/lang/Object;");
            cfw.add(ByteCode.POP);
    ...
    private void generateLocalYieldPoint(Node node, boolean exprContext) {
        ...
        if (node.getType() == Token.YIELD_STAR) {
            ...
            cfw.add(ByteCode.NEW, "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/ES6Generator$YieldStarResult");
            cfw.add(ByteCode.DUP_X1);
            cfw.add(ByteCode.SWAP);
            cfw.addInvoke(
                    ByteCode.INVOKESPECIAL,
                    "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/ES6Generator$YieldStarResult",
                    "<init>",
                    "(Ljava/lang/Object;)V");
        }
    ...
    private void generateFunctionAndThisObj(Node node, Node parent) {
        ...
        addScriptRuntimeInvoke(
                ...
                "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;" + ")Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;");
    }
    ...
    private static String exceptionTypeToName(int exceptionType) {
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            return "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            return "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            return "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/EcmaError";
    ...
    private void addInstructionCount(int count) {
        cfw.addALoad(contextLocal);
        cfw.addPush(count);
        addScriptRuntimeInvoke("addInstructionCount", "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;" + "I)V");
    }
    ...
    private void visitDotQuery(Node node, Node child) {
        ...
        addScriptRuntimeInvoke(
                "updateDotQuery",
                "(Z" + "Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;" + ")Ljava/lang/Object;");
        cfw.add(ByteCode.DUP);
        ...
        addScriptRuntimeInvoke(
                "leaveDotQuery",
                "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;" + ")Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;");
        cfw.addAStore(variableObjectLocal);
    }
