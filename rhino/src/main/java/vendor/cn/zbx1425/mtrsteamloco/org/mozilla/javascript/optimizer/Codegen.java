...
package vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.optimizer;

import static vendor.cn.zbx1425.mtrsteamloco.org.mozilla.classfile.ClassFileWriter.ACC_FINAL;
import static vendor.cn.zbx1425.mtrsteamloco.org.mozilla.classfile.ClassFileWriter.ACC_PRIVATE;
import static vendor.cn.zbx1425.mtrsteamloco.org.mozilla.classfile.ClassFileWriter.ACC_PROTECTED;
import static vendor.cn.zbx1425.mtrsteamloco.org.mozilla.classfile.ClassFileWriter.ACC_PUBLIC;
import static vendor.cn.zbx1425.mtrsteamloco.org.mozilla.classfile.ClassFileWriter.ACC_STATIC;
import static vendor.cn.zbx1425.mtrsteamloco.org.mozilla.classfile.ClassFileWriter.ACC_VOLATILE;
...
import vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.CompilerEnvirons;
import vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.Context;
import vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.Evaluator;
import vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.Function;
import vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.GeneratedClassLoader;
...
import vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.ObjArray;
import vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.ObjToIntMap;
import vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.RhinoException;
import vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.Script;
import vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.Scriptable;
import vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.SecurityController;
import vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.Token;
...
public class Codegen implements Evaluator {
    ...
    public Object compile(
        ...
        String mainClassName = "vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.gen." + baseName + "_" + serial;
    ...
    private byte[] generateCode(String encodedSource) {
        ...
        if (hasScript) {
            cfw.addInterface("vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Script");
    ...
    private void emitDirectConstructor(ClassFileWriter cfw, OptFunctionNode ofn) {
        ...
        */
        ...
        cfw.addInvoke(
                ...
                "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/BaseFunction",
                "createObject",
                "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;"
                        + "Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;"
                        + ")Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;");
        ...
        cfw.add(ByteCode.INSTANCEOF, "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw, boolean isStrictMode) {
        ...
        cfw.addInvoke(
                ByteCode.INVOKESTATIC,
                "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/ScriptRuntime",
                "hasTopCall",
                "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;" + ")Z");
        ...
        cfw.addInvoke(
                ...
                "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/ScriptRuntime",
                "doTopCall",
                "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Callable;"
                        + "Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;"
                        + "Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;"
                        + "Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;"
                        + "[Ljava/lang/Object;"
    ...
    private void generateMain(ClassFileWriter cfw) {
        ...
        cfw.addInvoke(
                ...
                mainMethodClass,
                "main",
                "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Script;[Ljava/lang/String;)V");
    ...
    private static void generateExecute(ClassFileWriter cfw) {
        ...
        cfw.addInvoke(
                ByteCode.INVOKEVIRTUAL,
                "vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.Context",
                "processMicrotasks",
                "()V");
    ...
    private void generateFunctionInit(ClassFileWriter cfw, OptFunctionNode ofn) {
        ...
        cfw.addInvoke(
                ByteCode.INVOKEVIRTUAL,
                "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/NativeFunction",
                "initScriptFunction",
                "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;" + "Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;" + ")V");
    ...
    private void emitRegExpInit(ClassFileWriter cfw) {
        ...
        cfw.addInvoke(
                ...
                "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/ScriptRuntime",
                "checkRegExpProxy",
                "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;" + ")Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/RegExpProxy;");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(
                        ...
                        "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/RegExpProxy",
                        "compileRegExp",
                        "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;"
    ...
    void pushNumberAsObject(ClassFileWriter cfw, double num) {
        if (num == 0.0) {
            ...
            cfw.add(
                    ByteCode.GETSTATIC,
                    "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/optimizer/OptRuntime",
                    "oneObj",
                    "Ljava/lang/Double;");
            return;
    ...
    static void pushUndefined(ClassFileWriter cfw) {
        cfw.add(
                ByteCode.GETSTATIC,
                "vendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Undefined",
                "instance",
                "Ljava/lang/Object;");
    }
    ...
    static final String DEFAULT_MAIN_METHOD_CLASS = "vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.optimizer.OptRuntime";

    private static final String SUPER_CLASS_NAME = "vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.NativeFunction";

    static final String ID_FIELD_NAME = "_id";

    static final String REGEXP_INIT_METHOD_NAME = "_reInit";
    static final String REGEXP_INIT_METHOD_SIGNATURE = "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;)V";
    ...
    static final String FUNCTION_CONSTRUCTOR_SIGNATURE =
            "(Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Scriptable;" + "Lvendor/cn/zbx1425/mtrsteamloco/org/mozilla/javascript/Context;I)V";
