...
public class NativeJavaObject implements Scriptable, SymbolScriptable, Wrapper, Serializable {
     ...
     * @see vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.Context#jsToJava(Object, Class)
     */
    @Deprecated
    ...
    static {
        ...
        Class<?> cl = Kit.classOrNull("vendor.cn.zbx1425.mtrsteamloco.org.mozilla.javascript.JavaAdapter");
        if (cl != null) {
            try {
