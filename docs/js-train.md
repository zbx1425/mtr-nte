...
| `train.doorLeftOpen[carIndex: int]: boolean`  | 左侧车门是否正在打开。                                                                                                                               |
| `train.doorRightOpen[carIndex: int]: boolean` | 右侧车门是否正在打开。                                                                                                                               |
